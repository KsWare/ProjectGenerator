...
namespace KsWare.ProjectGenerator
{
    ...
    /// </summary>
    public sealed class SelectFolderDialog
    {
        // https://dotnet-snippets.de/snippet/folderbrowserdialog-im-vista-style/14109
        ...
        void SetInitialFolder(IFileOpenDialog dialog)
        {
            ...
            if (!string.IsNullOrEmpty(FolderName))
            {
                IntPtr idl;
                uint atts = 0;
                if (NativeMethods.SHILCreateFromPath(FolderName, out idl, ref atts) == 0
